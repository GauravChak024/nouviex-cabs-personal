...
const { register, login, getAffiliateById, getAllAffiliates } = require('../controllers/affiliateAuth')
router.post('/register',upload, register)
router.post('/login',upload, login)
router.get('/user/:id', getAffiliateById)
router.get('/allUsers', getAllAffiliates)
